...
- Mass AltBalaji Accounts Checker v1.0 (Uploaded on 27/05/2020 2230 IST)
...
* Next, Run `git clone https://github.com/VoldemortCommunity/AltBalajiChecker`
* Navigate to the Newly Created AltBalajiChecker Directory using `cd AltBalajiChecker`
* To Start the Program Use `python AltBalajiChecker`
...
* Make Sure you move the Combo List to *Internal Storage/VoldemortCommunity/AltBalajiChecker/ComboLists*
* After Execution, You can Collect the Hits from *Internal Storage/VoldemortCommunity/AltBalajiChecker/Hits*
